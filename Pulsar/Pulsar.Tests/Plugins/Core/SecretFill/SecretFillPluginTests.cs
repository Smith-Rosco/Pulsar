...
{
    public class SecretFillPluginTests
    {
        ...
        private static SecretFillPlugin CreatePlugin(Mock<ISecretFillExecutionService> executionService)
        {
            return new SecretFillPlugin(NullLogger<SecretFillPlugin>.Instance, CreateLoc(), executionService.Object);
        }
        ...
        public async Task ExecuteAsync_ShouldDelegateFillActionToExecutionService()
        {
            ...
            executionService
                ...
                .ReturnsAsync(SecretFillExecutionResult.Ok(
        ...
        public async Task ExecuteAsync_ShouldSupportInjectAlias()
        {
            ...
            executionService
                .Setup(x => x.ExecuteAsync(It.IsAny<IReadOnlyDictionary<string, string>>(), It.IsAny<Pulsar.Core.Plugin.PulsarContext>()))
                .ReturnsAsync(SecretFillExecutionResult.Fail(SecretFillExecutionStage.Validation, "Missing required parameter: secretId"));
