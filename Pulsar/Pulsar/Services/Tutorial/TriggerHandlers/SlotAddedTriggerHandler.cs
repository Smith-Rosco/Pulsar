...
namespace Pulsar.Services.Tutorial.TriggerHandlers
{
    ...
    public class SlotAddedTriggerHandler : ITriggerHandler
    {
        ...
        private bool SlotMatchesCriteria(Models.ProfilesConfig config, string? criteriaJson)
        {
        ...
        /// 检查 Slot 列表是否匹配条件
        /// </summary>
        private bool CheckSlots(System.Collections.Generic.List<Models.PluginSlot> slots, 
