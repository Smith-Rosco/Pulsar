    ...
    public class LocaleExtension : MarkupExtension
    {
        ...
        public override object? ProvideValue(IServiceProvider serviceProvider)
        {
            ...
            if (serviceProvider.GetService(typeof(IProvideValueTarget)) is IProvideValueTarget target)
            {
                ...
                {
                    _targetObject = new WeakReference<DependencyObject>(dependencyObject);
                ...
                {
                    // Template/Style context — no DependencyObject target available yet.
                    // Hot-switch won't apply here; template elements re-evaluate on recreation.
                }
            }
