...
## Purpose
Define the animation behaviors and lifecycle guarantees used to drive radial menu layout transitions, paging feedback, and cursor magnetism through a unified controller.
...
- **THEN** `UpdateMagnetism(cursorPosition)` SHALL calculate an offset proportional to `(1 - distance/150)^2`
