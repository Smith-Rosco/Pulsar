...
Define how Pulsar is packaged and shipped: two distribution forms (installer and self-contained standalone), reproducible one-command publishing with a SHA256 manifest, upgrade/uninstall behaviour that preserves user data, and a packaging smoke test gate before publication.
