## Purpose
Define the dirty-state guard behavior for the settings experience so system-initiated loads and dialog drafts do not appear as user edits, while genuine user changes still surface unsaved state correctly.
