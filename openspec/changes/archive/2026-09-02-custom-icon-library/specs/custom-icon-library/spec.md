...
- No bundling/resizing/color-tinting of imported icons.
- No network icon sources; imports are local files only.
- No change to how `IconKey` is persisted in `Profiles.json` (it stays a string reference).
